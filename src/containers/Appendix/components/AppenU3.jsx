...
const AppenU3 = () => {
  return (
    <>
      ...
      <BasicP>
        Keplr, a browser extension, can be used in Google Chrome or
      ...
      <BasicP>
        Keplr allows users to manage their private keys by themselves without trusting others.
        So that they can use them safely (if they believe in Keplr's security) regardless of the
        website's security. The private key is stored on your local
        computer and is used to be signed offline.
      </BasicP>
      <Alert>
        The fact that Keplr has secured the security of the private key is only within the scope of
        using the key. It prevents applications from seizing private keys but does not prevent
        malicious behavior at the logic level, such as calling 'approve' on suspicious contracts.
      </Alert>
      <BasicP>Key features of Keplr include:</BasicP>
      <ListStyle>
        <li>Multi-chain account management, IBC transfer.</li>
        <li>Staking and claiming rewards to validators.</li>
