  ...
  return (
    <>
      <div class="flex container w-full mx-auto">
        ...
        >
          <L2C6U3S1Code difSuccess={difSuccess} ex={ex} ans={ans} />
        </button>
        <button
          className={
            openTab === 2
        ...
        >
          <L2C6U3S2Code difSuccess={difSuccess} ex={ex} ans={ans} />
        </button>
        <button
          className={
            openTab === 3
        ...
        >
          <L2C6U3S3Code difSuccess={difSuccess} ex={ex} ans={ans} />
        </button>
        <button
          className={
            openTab === 4
        ...
        >
          <L2C6U3S4Code difSuccess={difSuccess} ex={ex} ans={ans} />
        </button>
      </div>
      {difSuccess ? (
