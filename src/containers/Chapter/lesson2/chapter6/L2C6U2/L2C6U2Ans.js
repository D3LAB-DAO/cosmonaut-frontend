export const codeAns = {
  ...
  Q2: `pub fn execute_decrease_allowance(
    ...
    // Answer 1: allowance save or remove
        ...
        match current {
            Some(mut a) => {
                if a.expires.is_expired(block) {
                    ...
                    // Answer 1: deduct the allowance if enough
                    a.allowance = a
                        .allowance
                        .checked_sub(amount)
                        .map_err(StdError::overflow)?;
  ...
  Q4: `pub fn execute_send_from(
    ...
    // Answer 3: create a send message
