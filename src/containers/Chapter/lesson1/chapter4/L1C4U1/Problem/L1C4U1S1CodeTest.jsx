...
function L1C4U1S1CodeTest() {
  ...
  const [{ fmtRes, fmtLoading, fmtSuccess, fmtError }, fmtFetch] = usePostApi({
    files,
  });
  const { codeEx } = getTargetCodes({ lessonID, chID });
  console.log(codeEx);
...
export default L1C4U1S1CodeTest;
