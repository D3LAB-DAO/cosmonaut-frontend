        ...
        <EditorDesc>
                ...
                {hide ? null : (
                  <>
                    <ListStyle>
                      ...
                      <li>
                        <CodeBlock>Struct cosmwasm_std::Response</CodeBlock> has
                        a method
          ...
          <ProblemSection>
            ...
            <BasicP>
              ...
              <CodeBlock>config</CodeBlock>, so you need to find it among them.
            </BasicP>
            <BasicP>
                ...
                {hide ? null : (
                  <>
                    <ListStyle>
                      ...
                      <li>
                        Struct cosmwasm_std::Response has a method add_messages
                        as follow:
                        <Markdown code={code3} />
                      </li>
                    </ListStyle>
